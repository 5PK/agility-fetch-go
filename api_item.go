...
type LocaleItemIdGetRequest struct {
	ctx context.Context
...
func (r LocaleItemIdGetRequest) ContentLinkDepth(contentLinkDepth int32) LocaleItemIdGetRequest {
...
func (r LocaleItemIdGetRequest) ExpandAllContentLinks(expandAllContentLinks bool) LocaleItemIdGetRequest {
	r.expandAllContentLinks = &expandAllContentLinks
	return r
}

func (r LocaleItemIdGetRequest) Execute() (*HeadlessContentItem, *http.Response, error) {
	return r.ApiService.ItemIdGetExecute(r)
}

/*
ItemIdGet Gets the details of a content item by ther Content ID.
 ...
 @param id The contentID of the requested item in this locale.
 @return LocaleItemIdGetRequest
*/
func (a *ItemAPIService) ItemIdGet(ctx context.Context, guid string, apitype APIType, locale string, id int32) LocaleItemIdGetRequest {
	return LocaleItemIdGetRequest{
		ApiService: a,
		ctx: ctx,
		guid: guid,
...
//  @return HeadlessContentItem
func (a *ItemAPIService) ItemIdGetExecute(r LocaleItemIdGetRequest) (*HeadlessContentItem, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *HeadlessContentItem
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ItemAPIService.ItemIdGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/{guid}/{apitype}/{locale}/item/{id}"
